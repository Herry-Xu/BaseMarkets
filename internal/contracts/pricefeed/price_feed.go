...
var ContractsMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"getLatestPrice\",\"outputs\":[{\"internalType\":\"int256\",\"name\":\"\",\"type\":\"int256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getLatestTimestamp\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}
...
func (_Contracts *ContractsCaller) GetLatestTimestamp(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Contracts.contract.Call(opts, &out, "getLatestTimestamp")
...
//
// Solidity: function getLatestTimestamp() view returns(uint256)
func (_Contracts *ContractsSession) GetLatestTimestamp() (*big.Int, error) {
	return _Contracts.Contract.GetLatestTimestamp(&_Contracts.CallOpts)
}

// GetLatestTimestamp is a free data retrieval call binding the contract method 0xf43b52cb.
//
// Solidity: function getLatestTimestamp() view returns(uint256)
func (_Contracts *ContractsCallerSession) GetLatestTimestamp() (*big.Int, error) {
	return _Contracts.Contract.GetLatestTimestamp(&_Contracts.CallOpts)
}
